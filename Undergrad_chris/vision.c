...
*/
		// if(mouse.x>0) // Draw where mouse clicks
...
// DRAW ARENA AND GOAL
		...
		draw_circle(&img_m_color_for_display, draw_x, draw_y); // Calibration point
		// draw_occ_grid(&img_m_color_for_display, occ_grid);
		draw_path(&img_m_color_for_display, Path_vision);
		draw_circle(&img_m_color_for_display, click_x, click_y); // Draw where next click is
